    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border border-border rounded-xl p-6 bg-card space-y-4">
          ...
          <a href="/webinars" className="flex items-center gap-2 w-full justify-center px-4 py-2.5 rounded-lg bg-brand-500 text-white text-sm font-medium hover:bg-brand-600 transition-colors">
